...
const SAMPLE_NOTIFICATIONS = [
   ...
   },
   {
      ...
      detail:
         "A moderator has updated the verdict confidence for one of your posts.",
      time: "18m ago",
      isRead: false,
   },
   {
      ...
      detail:
         "A community member submitted additional source evidence on your thread.",
      time: "1h ago",
      isRead: true,
   },
   {
      ...
      detail:
         "Review your account settings and keep your contact details up to date.",
      time: "Yesterday",
      isRead: true,
   },
];
...
function NotificationPage() {
   ...
   const [loading] = useState(false); // No API integration yet

   const filteredNotifications =
      activeFilter === "unread"
         ? SAMPLE_NOTIFICATIONS.filter((n) => !n.isRead)
      ...
      <div className="notifications-layout">
         ...
         <main className="notification-container">
            <header className="notifications-header">
               <div>
                  ...
                  <p className="notifications-subtitle">
                     Stay up to date with moderation activity and community
                     engagement.
                  </p>
               </div>
            ...
            <section className="notifications-toolbar box-panel">
               ...
               <button type="button" className="mark-read-btn">
               ...
               <section className="notifications-list box-panel">
                  {filteredNotifications.length === 0 ? (
                     <div className="notification-empty-state">
                        <Icons name="bell-off" size={28} color="#94a3b8" />
                        <h2>No unread notifications</h2>
                        <p>
                           Everything is up to date. New alerts will appear
                           here.
                        </p>
                     </div>
                  ) : (
